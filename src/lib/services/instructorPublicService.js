class InstructorPublicService {
  ...
  static async getAllInstructors(params = {}) {
    try {
      ...
      const response = await fetch(
        `api/public/instructors?${searchParams.toString()}`,
        {
          method: "GET",
          headers: {
  ...
  static async getInstructorById(instructorId) {
    try {
      ...
      const response = await fetch(
        `${this.baseUrl}/api/public/instructor/${instructorId}`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
  ...
  static async getInstructorCourses(instructorId, params = {}) {
    try {
      ...
      const response = await fetch(
        `${
          this.baseUrl
        }/api/public/instructor/${instructorId}/courses?${searchParams.toString()}`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
      ...
      return {
        success: false,
        message:
          error.message || "Network error while fetching instructor courses",
      };
    }
  }
  ...
  static async getInstructorStats(instructorId) {
    try {
      const response = await fetch(
        `${this.baseUrl}/api/public/instructor/${instructorId}/stats`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
      ...
      return {
        success: false,
        message:
          error.message || "Network error while fetching instructor stats",
      };
    }
  }
}
